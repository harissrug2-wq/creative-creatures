(() => {
  ...
  if (!host) return;
  host.innerHTML = `<header class="cc-topbar"><button class="cc-menu-toggle" aria-label="Open navigation">${icons.menu}</button><a class="cc-brand" href="/platform/"><img src="/monitor/creative-creatures-logo.png" alt="Creative Creatures"></a><div class="cc-mobile-title">Creative Creatures</div><nav class="cc-topnav">${linkHtml}</nav><div class="cc-actions"><a class="cc-upgrade" href="/account/upgrade/" hidden>Upgrade</a><button class="cc-ask" type="button" data-cc-ask hidden><img src="/favicon.svg" class="cc-ask-logo-icon" alt="" style="width:16px;height:16px;object-fit:contain;margin-right:6px;vertical-align:middle;"><span>Ask Creature</span></button></div></header><nav class="cc-mobile-panel">${linkHtml}<a class="cc-nav-link cc-mobile-upgrade" href="/account/upgrade/" hidden>Upgrade account</a></nav><div class="cc-lock-tip" role="status"></div>`;
