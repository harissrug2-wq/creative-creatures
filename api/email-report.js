...
export default async function handler(req,res){
  ...
  try{
    ...
    const isArchetypeReport = body.type === 'owner-archetype' || !body.type || clean(body.title).toLowerCase().includes('owner') || clean(body.title).toLowerCase().includes('archetype');
