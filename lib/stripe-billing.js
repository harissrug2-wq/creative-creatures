...
export const PLANS = Object.freeze({
  diagnostic: { label:'1:1 Analysis & Planning Diagnostic', mode:'payment', amount:640000, prices:[['STRIPE_PRICE_DIAGNOSTIC',640000,null]] },
  ...
  platform: { label:'Platform / Partner Portal', mode:'subscription', amount:49700, prices:[['STRIPE_PRICE_PLATFORM',49700,'month']] },
