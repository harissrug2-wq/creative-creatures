...
const pageLoaderPlugin = {
  ...
  transformIndexHtml(html) {
    return [
      ...(/rel=["'](?:shortcut )?icon["']/.test(html) ? [] : [{ tag: 'link', attrs: { rel: 'icon', type: 'image/png', href: '/brand/creature-icon.png' }, injectTo: 'head' }]),
      ...
      { tag: 'link', attrs: { rel: 'stylesheet', href: '/shared/page-loader.css' }, injectTo: 'head' },
      {
        ...
        children: '<div class="cc-loader-card"><div class="cc-loader-mark"><span class="cc-loader-orbit"></span><img src="/brand/creature-icon.png" alt=""></div><div class="cc-loader-copy"><strong>Creative Creatures</strong><span data-loader-copy>Loading your agency workspace…</span></div></div>',
  ...
  build: {
    rollupOptions: {
      input: {
        ...
        zoomDocs: resolve(__dirname, 'docs', 'zoom', 'index.html'),
        ...
        fractionalCoo: page('fractional-coo'),
        signupFractionalCoo: resolve(__dirname, 'signup', 'fractional-coo', 'index.html'),
        signupPlatform: resolve(__dirname, 'signup', 'platform', 'index.html'),
        signupAccelerator: resolve(__dirname, 'signup', 'accelerator', 'index.html'),
        signupDiagnostic: resolve(__dirname, 'signup', 'diagnostic', 'index.html'),
        signup3: page('signup-3'),
        signup3FractionalCoo: resolve(__dirname, 'signup-3', 'fractional-coo', 'index.html'),
        signup3Platform: resolve(__dirname, 'signup-3', 'platform', 'index.html'),
        signup3Accelerator: resolve(__dirname, 'signup-3', 'accelerator', 'index.html'),
        signup3Diagnostic: resolve(__dirname, 'signup-3', 'diagnostic', 'index.html'),
      },
    },
  },
});
